		...
		if(isset($_POST['About']))
		{
			...
			{   
                if(!empty($model->image_name)){
                    ...
                    $file = $_SERVER['DOCUMENT_ROOT'] . Yii::app()->getBaseUrl() . Yii::app()->params['imagePath'] .$imageName;
                    ...
                    ->save($_SERVER['DOCUMENT_ROOT'] . Yii::app()->getBaseUrl() . Yii::app()->params['imagePath'] . $imageName); //перезапись уже ужатой картинкой
