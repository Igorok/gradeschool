...
class AudiocategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Audiocategory']))
		{
			$model->attributes=$_POST['Audiocategory'];
			if($model->save())
	...
	{
		$model=new Audiocategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Audiocategory']))
			$model->attributes=$_GET['Audiocategory'];
	 ...
	 * @param Audiocategory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='audio-category-form')
		{
