<div class="row-fluid">
    ...
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Управление категориями изображений</div>
    </div>
...
$('.search-form form').submit(function(){
	$('#image-category-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div>
    <?php echo CHtml::link('<i class="icon-file icon-white"></i>&nbsp;Создать', array('imagecategory/create'), array('class'=>'btn btn-primary')) ?>
    <!-- -->
