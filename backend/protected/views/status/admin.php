<div class="row-fluid">
    ...
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Управление статусами</div>
    </div>
...
<div>
    <?php echo CHtml::link('<i class="icon-file icon-white"></i>&nbsp;Создать', array('status/create'), array('class'=>'btn btn-primary')) ?>
    <!-- -->
