<div class="row-fluid">
    ...
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Управление изображениями</div>
    </div>
...
<div>
    <?php echo CHtml::link('<i class="icon-file icon-white"></i>&nbsp;Создать', array('image/create'), array('class'=>'btn btn-primary')) ?>
    <!-- -->
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        'name'=>'image_name',
			...
			// одинарные ковычки.
			'value'=> 'file_exists($_SERVER["DOCUMENT_ROOT"] . Yii::app()->getBaseUrl() . Yii::app()->params["userImagesPath"] . $data->image_name) && !empty($data->image_name) ? Yii::app()->request->baseUrl . Yii::app()->params["userImagesPath"] . $data->image_name : Yii::app()->request->baseUrl . Yii::app()->params["userImagesPath"] . "noeventimage.png"',
			'filter'=>'',
