<div class="row-fluid">
    ...
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Управление голосованиями</div>
    </div>
...
$('.search-form form').submit(function(){
	$('#vote-question-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div>
    <?php echo CHtml::link('<i class="icon-file icon-white"></i>&nbsp;Создать', array('voteQuestion/create'), array('class'=>'btn btn-primary')) ?>
    <!-- -->
